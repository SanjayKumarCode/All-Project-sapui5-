		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Table Action",
									"targetURL": "#comexampletableaction-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampletableaction-display": {
								"semanticObject": "comexampletableaction",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.tableaction",
									"url": sap.ui.require.toUrl("com/example/tableaction")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List and Detail Page",
									"targetURL": "#comexamplelistanddetailpage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplelistanddetailpage-display": {
								"semanticObject": "comexamplelistanddetailpage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.listanddetailpage",
									"url": sap.ui.require.toUrl("com/example/listanddetailpage")
								}
							}
						}
					}

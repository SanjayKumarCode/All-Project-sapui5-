		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "task",
									"targetURL": "#comexampletask-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampletask-display": {
								"semanticObject": "comexampletask",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.task",
									"url": sap.ui.require.toUrl("com/example/task")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "assignwork",
									"targetURL": "#comexampleassignwork-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleassignwork-display": {
								"semanticObject": "comexampleassignwork",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.assignwork",
									"url": sap.ui.require.toUrl("com/example/assignwork")
								}
							}
						}
					}

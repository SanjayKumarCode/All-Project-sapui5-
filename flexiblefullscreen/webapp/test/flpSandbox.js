		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "flexiblefullscreen",
									"targetURL": "#comexampleflexiblefullscreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleflexiblefullscreen-display": {
								"semanticObject": "comexampleflexiblefullscreen",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.flexiblefullscreen",
									"url": sap.ui.require.toUrl("com/example/flexiblefullscreen")
								}
							}
						}
					}

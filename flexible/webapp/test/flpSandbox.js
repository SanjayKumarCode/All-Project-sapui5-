		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "flexible",
									"targetURL": "#comexampleflexible-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleflexible-display": {
								"semanticObject": "comexampleflexible",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.flexible",
									"url": sap.ui.require.toUrl("com/example/flexible")
								}
							}
						}
					}

...
sap.ui.define(["sap/ui/base/Object"], function (UI5Object) {
	...
	var sMockdataPath = jQuery.sap.getModulePath("com.example.salesorder") + "/model/api/mockdata/";
	...
	return UI5Object.extend("com.example.salesorder.model.api.provider.MockProvider", {
		_iDelay: 1000,
		_oData: {},
			...
			var oPromise = new Promise(
				function (resolve, reject) {
					this._onDataReady().then(
						function () { 	
								resolve(this._oData.salesorder);							
						}.bind(this)
					);
				}.bind(this)
			);

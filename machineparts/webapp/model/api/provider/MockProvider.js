...
sap.ui.define(["sap/ui/base/Object"], function (UI5Object) {
	...
	var sMockdataPath = jQuery.sap.getModulePath("com.example.machineparts") + "/model/api/mockdata/";
	...
	return UI5Object.extend("com.example.machineparts.model.api.provider.MockProvider", {
		_iDelay: 1000,
		_oData: {},
			...
			var oPromise = new Promise(
				function (resolve, reject) {
					this._onDataReady().then(
						function () { 	
								resolve(this._oData.machineparts);							
						}.bind(this)
					);
				}.bind(this)
			);
				...
				function (resolve, reject) {
					this._onDataReady().then(
						function () { 
							debugger;
								// STANDARD EXECUTION
								this._oData.machineparts = this._oData.machineparts.find(
									function (oRequestDetailItem){
										return (
											oRequestDetailItem.COMMODITY_TYPE === sID
										);
									});
								resolve(this._oData.machineparts);							
						}.bind(this)

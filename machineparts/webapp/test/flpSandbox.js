		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "machineparts",
									"targetURL": "#comexamplemachineparts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplemachineparts-display": {
								"semanticObject": "comexamplemachineparts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.machineparts",
									"url": sap.ui.require.toUrl("com/example/machineparts")
								}
							}
						}
					}
